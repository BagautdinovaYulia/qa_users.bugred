...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        time.sleep(3)
        self.element_is_visible(self.locators.INPUT_NAME).send_keys("John")
        self.element_is_visible(self.locators.INPUT_EMAIL).send_keys("john123@test.com")
        self.element_is_visible(self.locators.INPUT_PASSWORD).send_keys("12345qa")
        self.element_is_visible(self.locators.BUTTON_ADD_USER).click()
        time.sleep(3)
        # return person.email
